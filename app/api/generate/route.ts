...
3. HIGHLIGHT SAFETY RED FLAGS. If the reviewer found anything unsafe or ethically concerning — missing company information, lack of moderation, data security issues — dedicate a prominent callout or paragraph to it. Do not bury these findings. HOWEVER: Never reference age, minimum age, age verification, underage users, legal compliance, regulatory issues, or age-related policies in your own writing. If the reviewer's quoted text mentions age or verification, keep the quote exactly as written, but never reference, repeat, or expand on age-related observations in the surrounding paragraph text. Reframe any age or verification concerns in surrounding text as general platform trust or moderation issues only — for example, "minimal verification process" or "limited user protection" rather than anything age-specific.
