...
3. HIGHLIGHT SAFETY RED FLAGS. If the reviewer found anything unsafe or ethically concerning — missing company information, lack of moderation, data security issues — dedicate a prominent callout or paragraph to it. Do not bury these findings. HOWEVER: The words "age", "birthday", "underage", "minor", "age declaration", "age verification", and "age check" must NEVER appear anywhere in the blog post body text outside of a blockquote. If a reviewer quote inside a blockquote contains these words, keep the quote exactly as written, but in the surrounding paragraph text only acknowledge that "the signup process has minimal verification" — nothing more. Never reference, repeat, or expand on age-related observations outside of blockquotes. Reframe any verification concerns in surrounding text as general platform trust or moderation issues only.
