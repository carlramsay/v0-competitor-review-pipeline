...
const files = {
  "lib/supabase-store.ts": `"use client"
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="mx-auto max-w-2xl">
        <h1 className="mb-2 text-2xl font-bold text-foreground">Download Files for GitHub</h1>
        <p className="mb-8 text-muted-foreground">
          Click each button to download the file, then upload to GitHub.
        </p>
        ...
        <div className="space-y-4">
          {Object.entries(files).map(([filename, content]) => (
            ...
            >
              ...
              >
                {downloaded[filename] ? "Downloaded" : "Download"}
              </button>
            </div>
          ))}
        </div>
        ...
        <div className="mt-8 space-y-4">
          <h2 className="text-lg font-semibold text-foreground">Additional Files (Large)</h2>
          <div className="space-y-3">
            <a
              href="/download-files/types"
            ...
            >
              <span className="font-mono text-sm text-foreground">lib/types.ts</span>
              <span className="text-xs text-muted-foreground">Click to download</span>
            </a>
            <a
              href="/download-files/review-utils"
              className="flex items-center justify-between rounded-lg border border-border bg-card p-4 hover:bg-muted/50 transition-colors"
            >
              <span className="font-mono text-sm text-foreground">lib/review-utils.ts</span>
              <span className="text-xs text-muted-foreground">Click to download</span>
            </a>
            <a
              href="/download-files/settings"
              className="flex items-center justify-between rounded-lg border border-border bg-card p-4 hover:bg-muted/50 transition-colors"
            >
              <span className="font-mono text-sm text-foreground">app/admin/settings/page.tsx</span>
              <span className="text-xs text-muted-foreground">Click to download</span>
            </a>
            <a
              href="/download-files/content-generation"
              className="flex items-center justify-between rounded-lg border border-border bg-card p-4 hover:bg-muted/50 transition-colors"
            >
              <span className="font-mono text-sm text-foreground">components/content-generation.tsx</span>
              <span className="text-xs text-muted-foreground">Click to download</span>
            </a>
          </div>
        </div>
